...
class DialogShowNote: DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        if(!note!!.important){
            //if it is not important it will be not visible.
        ...
        builder.setView(dialogLayout).setMessage(resources.getString((R.string.your_note))) //heading of the screen

        return builder.create()
    }

    //gönderilen note almak için böyle bir method oluşturduk.
